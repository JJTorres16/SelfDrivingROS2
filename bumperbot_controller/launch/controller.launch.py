...
def noisy_controller(context, *args, **kargs):
    ...
    use_pyhton = LaunchConfiguration("use_python")
    ...
    noisy_controller_py = Node(
        ...
        condition=IfCondition(use_pyhton)
    )
...
def generate_launch_description():
    ...
    whee_separation_arg = DeclareLaunchArgument(
        "wheel_separation",
        default_value="0.17"
    )
    ...
    # Function to access to the real time value of the arguments and performe some calculation
